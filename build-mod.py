...
mods = ["AutoLegality", "PGLRentalLegality", "MGDBDownloader", "URLGenning", "ExportTrainerData", "SmogonGenner"]
new_files = []
resource_files = ["AutoLegality\\AutoLegalityMod.resx", "AutoLegality\\AutoLegalityMod.Designer.cs"]
image_files = ["AutoLegality\\Resources\\img\\menuautolegality.png", "AutoLegality\\Resources\\img\\autolegalitymod.png", "AutoLegality\\Resources\\img\\mgdbdownload.png", "AutoLegality\\Resources\\img\\pglqrcode.png", "AutoLegality\\Resources\\img\\urlimport.png", "AutoLegality\\Resources\\img\\exporttrainerdata.png", "AutoLegality\\Resources\\img\\smogongenner.png"]
...
user_controls = ["AutoLegality\\ArchitMod.cs", "AutoLegality\\PKSMAutoLegality.cs", "URLGenning\\URLGenning.cs", "ExportTrainerData\\ExportTrainingData.cs", "SmogonGenner\\SmogonGenner.cs"]
...
for file in new_files:
    ...
    if file == "SmogonGenner\\SmogonGenner.Designer.cs":
        child2 = etree.SubElement(child, "DependentUpon")
        child2.text = "SmogonGenner.cs"
