...
- Right click on the `PKHeX.WinForms` subproject, and select `Add>Reference`
- Check the box for `System.IO.Compression` and `System.IO.Compression.FileSystem`. Click OK.
